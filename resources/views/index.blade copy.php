...
<div class="main w-screen h-screen relative">
    <div class="flex flex-col gap-y-2 px-5 justify-center items-start h-full">
        <div class="text-slate-800 text-3xl md:text-5xl text-center">We Build the Nation</div>
        <p class="md:w-1/2 text-slate-600 text-center">Welcome to our vibrant school community, where curiosity meets knowledge, and every student is encouraged to thrive academically, socially, and creatively. </p>
        <a href="">
            <button class="btn-orange mt-5">Click Here <i class="bi-arrow-right"></i></button>
        </a>
    </div>
    <div class="absolute top-40 right-64 rounded-full">
        <img src="{{ url(asset('images/bg/office.png')) }}" alt="" class="rounded-full  w-96 h-96">
