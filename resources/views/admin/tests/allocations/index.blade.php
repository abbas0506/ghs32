                ...
                <tr class="tr">
                    ...
                    <td>
                        <div class="flex justify-center items-center space-x-2">
                            ...
                            <form action="{{route('admin.test.allocations.destroy',[$test, $testAllocation])}}" method="POST" onsubmit="return confirmDel(event)">
                                @csrf
                                @method('DELETE')
...
<a href="{{ route('admin.test.allocations.create',$test) }}" class="flex w-12 h-12 justify-center items-center fixed bottom-4 right-4 btn-blue rounded-full"><i class="bi-plus"></i></a>
@endsection
@section('script')
