    ...
    <main>
        <div class="container">
            ...
            <div class="w-1/2 mx-auto">
                ...
                <table class="w-full">
                    <tbody>
                        <tr>
                            <td class="text-center text-xl font-bold">Class Result - {{ $test->title }}</td>
                        </tr>
                        <tr>
                            <td class="text-center text-m font-bold">Govt Higher Secondary School Chak Bedi, Pakpattan</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <h3 class="mt-8 underline text-center">Class: {{ $section->roman() }}</h3>
        ...
        <div class="w-1/2 mx-auto">
            ...
            <table class="w-full">
                <tbody>
                    <tr>
                        <td class="text-center text-xl font-bold">Report Card - {{ $test->title }}</td>
                    </tr>
                    <tr>
                        <td class="text-center text-m font-bold">Govt Higher Secondary School Chak Bedi, Pakpattan</td>
                    </tr>
