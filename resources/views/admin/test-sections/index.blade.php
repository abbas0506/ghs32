                        ...
                        <tr class="border-b">
                            ...
                            <td>
                                <a href="{{ route('admin.test.section.result.print', [$test, $section]) }}" target="_blank"
                                    class="w-16"><i class="bi-printer"></i></a>
                            </td>
                            <td>
                                <a href="{{ route('admin.test.section.positions.print', [$test, $section]) }}"
                                    target="_blank" class="w-16"><i class="bi-printer"></i></a>
                            </td>
                            <td>
                                <a href="{{ route('admin.test.section.report-cards.print', [$test, $section]) }}"
                                    target="_blank" class="w-16"><i class="bi-printer"></i></a>
                            </td>
