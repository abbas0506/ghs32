...
@section('page-content')
    <div class="custom-container">
        ...
        <div class="flex justify-center items-center gap-3 flex-wrap mt-5">
            ...
            <a href="{{ route('admin.sections.import', $section) }}" class=""><i
                    class="bi bi-file-earmark-plus text-teal-600"></i></a>
            <a href="{{ route('admin.sections.export', $section) }}" class=""><i
                    class="bi bi-arrow-right-square text-teal-600"></i></a>
            <a href="{{ route('admin.sections.reset', $section) }}" class=""><i
            ...
            <a href="{{ route('admin.sections.clean', $section) }}" class=""><i
                    class="bx bx-recycle text-orange-600"></i></a>
            <a href="{{ route('admin.sections.print', $section) }}" class=""><i
                ...
                <tbody>
                    @foreach ($section->students->sortBy('rollno') as $student)
                        <tr class="tr">
                            ...
                            <td class="text-left">
                                <a href="{{ route('admin.section.students.show', [$section, $student]) }}"
