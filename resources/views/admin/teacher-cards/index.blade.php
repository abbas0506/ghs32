...
<div class="custom-container">
    ...
    <form action="{{ route('admin.teacher-cards.store') }}" method="post">
        @csrf
        <div class="flex mt-4">
            <!-- search -->
            ...
            <table class="table-fixed borderless w-full">
                <thead>
                    <tr class="">
                        ...
                        <th class="w-40 text-left">Designation</th>
                ...
                <tbody>
                    ...
                    <tr class="tr text-sm border-b">
                        ...
                        <td class="text-left"><a href="" class="link">{{ $teacher->name }}</a></td>
                        <td class="text-left">{{ $teacher->designation}} ({{ $teacher->bps }}) </td>
                        <td><img src="{{ asset('storage/' . $teacher->photo) }}" alt="photo" class="rounded mx-auto w-8 h-8"></td>
                        <td><input type="checkbox" class="w-4 h-4 rounded" name="ids_array[]" value="{{ $teacher->id }}"></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
