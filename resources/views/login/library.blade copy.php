...
<div class=" bg-white flex flex-col items-center justify-center p-5 h-screen w-screen">
    <div class="w-full sm:w-1/2 lg:w-1/4">
        ...
        <form action="{{url('login')}}" method="post" class="w-full mt-1">
            @csrf
            <input type="text" name="login_id" class="hidden" value="library@ghsscb.edu.pk">
            <h2 class="text-center w-full">Welcome to Library Portal</h2>
            <p for="" class="text-center w-full">library@ghss.edu.pk</p>
