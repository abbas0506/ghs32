    ...
    <div class="custom-container">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-3 mt-12">
            ...
            <div class="flex space-x-2 items-center">
                <a href="{{ route('admission.section.students.create', $section) }}" class="btn-teal rounded">Import &nbsp <i
                ...
                <tbody>
                    @foreach ($section->students->sortBy('rollno') as $student)
                        <tr class="tr">
                            ...
                            <td class="text-left"><a href="{{ route('admin.section.students.show', [$section, $student]) }}"
                            ...
                            <td>
                                <form action="{{ route('admission.section.students.destroy', [$student, $section]) }}"
