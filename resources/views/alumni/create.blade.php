...
<section>
    <div class="max-w-full m-5 md:mx-auto lg:w-2/3  mt-24 bg-white">
        ...
        <div class="px-5 shadow-lg">
            <form action="{{ route('alumni.store') }}" method="post" id='applicationForm' class="w-full py-5 md:px-16" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid md:grid-cols-2 gap-3 mt-6">
                    <div class="">
                        ...
                        <input type="text" name="name" class="custom-input fancy-focus" placeholder="Name" required>
                    </div>
                    <div>
                        <label for="">Phone <i class="bi-whatsapp"></i></label>
                        <input type="text" name="phone" id='phone' class="custom-input fancy-focus phone" placeholder="Phone" required>
                    </div>

                    <div class="">
                        <label for="">Village Name <i class="bi-house"></i></label>
                        <input type="text" name="address" id='address' class="custom-input fancy-focus" placeholder="for example: 32/2L" required>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        <label for="introduction">Brief Introduction (maximum 100 characters)<i class="bi-numeric"></i></label>
                        <input type="text" name="introduction" class="custom-input fancy-focus" placeholder="for example: Currently serving as a police officer" required>
                    </div>
